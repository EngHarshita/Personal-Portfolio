...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const mobileNavLinks = document.querySelectorAll('.mobile-nav-links .mobile-nav-link'); // Corrected selector
    ...
    const desktopNavLinks = document.querySelectorAll('.nav-links .nav-link'); // Renamed for clarity
    ...
    function setActiveLink() {
        ...
        desktopNavLinks.forEach(link => { // Used desktopNavLinks
